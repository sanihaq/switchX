...
- Use `pkg:cli_pkg` for creating binaries in CI.
  Thanks
  [Guillaume](https://github.com/filiph/switchX/commits?author=Mogztter)!
...
- Fix `--show-redirects` functionality.
  [Thanks @nfagerlund!](https://github.com/filiph/switchX/pull/64)!

## 2.0.15

- Improve stability by handling several failures more gracefully
  ([#57](https://github.com/filiph/switchX/issues/57),
  [#63](https://github.com/filiph/switchX/issues/63),
  [#51](https://github.com/filiph/switchX/issues/51),
  [#40](https://github.com/filiph/switchX/issues/40))
...
- Add the `--no-check-anchors` flag, which prevents reporting missing anchors
  ...
  [Thanks @emielbeinema](https://github.com/filiph/switchX/pull/56)
...
- Add the `--show-redirects` flag, which reports redirected links.
  ...
  [Thanks @emielbeinema](https://github.com/filiph/switchX/pull/54)
  for this contribution!
...
- Guard against servers that do not provide `Content-Type`. No guarantees about
  crawling such servers but at least `switchX` will not crash.
